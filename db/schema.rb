...
ActiveRecord::Schema.define(version: 20161126005115) do
  ...
  add_index "snippets", ["cached_votes_down"], name: "index_snippets_on_cached_votes_down", using: :btree
  add_index "snippets", ["cached_votes_score"], name: "index_snippets_on_cached_votes_score", using: :btree
  add_index "snippets", ["cached_votes_total"], name: "index_snippets_on_cached_votes_total", using: :btree
  add_index "snippets", ["cached_votes_up"], name: "index_snippets_on_cached_votes_up", using: :btree
  add_index "snippets", ["cached_weighted_average"], name: "index_snippets_on_cached_weighted_average", using: :btree
  add_index "snippets", ["cached_weighted_score"], name: "index_snippets_on_cached_weighted_score", using: :btree
  add_index "snippets", ["cached_weighted_total"], name: "index_snippets_on_cached_weighted_total", using: :btree
